...
def create_search_term(db: Session, term: str) -> str:
...
def create_generated_content(db: Session, content: str, search_term_id: int) -> str:
...
def create_sentiment_analysis(db: Session, readability: str, sentiment: str, search_term_id: int) -> str:
